...
| `PREDICTION_MIN_HORIZON_SECONDS` | `0` | Closer than this, the agency's time stands. Zero: a measured bias is corrected at any distance |
| `PREDICTION_MIN_CORRECTION_SECONDS` | `30` | Smallest correction to start showing; once shown it stays until below half of this, so times don't flicker |
